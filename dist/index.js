...
async function main() {
    try {
        ...
        (0, core_1.exportVariable)("type", results.type);
        (0, core_1.exportVariable)("version", results.version);
        (0, core_1.exportVariable)("old-version", results.oldVersion);
        (0, core_1.exportVariable)("tag", results.tag);
        (0, core_1.exportVariable)("access", results.access);
        (0, core_1.exportVariable)("dry-run", results.dryRun);
    }
    catch (error) {
        errorHandler(error);
    }
